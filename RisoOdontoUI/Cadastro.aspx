<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="RisoOdontoUI.Cadastro" %>
    ...
    <div class="box">
        <form id="form1" runat="server">
           <fieldset>
                    ...
                    <br><br>
                    <div class="inputBox">
                        <asp:TextBox type="text" id="txtTelefone" class="inputUser" runat="server"  required/>
